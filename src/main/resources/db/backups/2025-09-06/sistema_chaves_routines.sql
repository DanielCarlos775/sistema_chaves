...
--
-- Dumping events for database 'sistema_chaves'
--

--
-- Dumping routines for database 'sistema_chaves'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_inserir_agendamento` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_inserir_agendamento`(
    IN p_id_sala INT,
    IN p_id_usuario INT,
